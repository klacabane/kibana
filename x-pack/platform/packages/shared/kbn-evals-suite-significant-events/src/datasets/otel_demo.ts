      ...
      output: {
        criteria: [
          ...
          },
          {
            ...
            score: 1,
            sampling_filter: [{ term: { 'resource.attributes.app': 'payment' } }],
          },
          {
          ...
          },
          {
            ...
            score: 1,
            sampling_filter: [{ term: { 'resource.attributes.app': 'recommendation' } }],
          },
          {
            id: 'entity-quote',
            text: 'Must identify quote service as an entity (evidence: resource.attributes.app=quote)',
            score: 1,
            sampling_filter: [{ term: { 'resource.attributes.app': 'quote' } }],
          },
          {
