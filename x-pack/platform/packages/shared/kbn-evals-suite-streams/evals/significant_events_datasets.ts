        ...
        input: buildInput({
          ...
          additionalFeatures: [
            ...
            }),
            {
              ...
              evidence: [
                {
                  text: 'sshd[20954]: Failed password for invalid user admin from 192.168.1.100 port 54321',
                },
              ],
        ...
        input: buildInput({
          ...
          additionalFeatures: [
            ...
            }),
            {
              ...
              confidence: 95,
              evidence: [
                { text: 'systemd[1]: Started Session 123 of user root.' },
                { text: 'systemd[1]: Stopping System Logging Service...' },
              ],
        ...
        input: buildInput({
          ...
          additionalFeatures: [
            ...
            }),
            {
              ...
              evidence: [
                {
                  text: 'java.lang.NullPointerException: Attempt to invoke virtual method on a null object reference',
                },
                { text: 'at com.example.myproject.MyClass.myMethod(MyClass.java:123)' },
              ],
              tags: ['error', 'java'],
              meta: {},
            },
        ...
        input: buildInput({
          ...
          additionalFeatures: [
            ...
            }),
            {
              ...
              confidence: 90,
              evidence: [{ text: '"GET /api/user HTTP/1.1" 503 1234' }],
              tags: ['web', 'http'],
              meta: {},
            },
          ],
        ...
        input: buildInput({
          ...
          additionalFeatures: [
            ...
            }),
            {
              ...
              confidence: 95,
              evidence: [
                { text: "Unable to find image 'nonexistent-image:latest' locally" },
                { text: 'docker: Error response from daemon: pull access denied' },
              ],
        ...
        input: buildInput({
          ...
          additionalFeatures: [
            ...
            }),
            {
              ...
              confidence: 95,
              evidence: [
                { text: 'could not connect to database "postgres": Connection refused' },
                { text: 'accepting TCP/IP connections on port 5432' },
              ],
        ...
        input: buildInput({
          ...
          additionalFeatures: [
            ...
            }),
            {
              ...
              confidence: 90,
              evidence: [
                { text: 'WARN: /var/log is 95% full' },
                { text: 'CRITICAL: /var/log is 99% full' },
              ],
          ...
          return buildInput({
            ...
            additionalFeatures: [
              ...
              }),
              {
                ...
                confidence: 95,
                evidence: sampleLogs.slice(0, 2).map((text) => ({ text })),
                tags: ['web', 'nginx'],
                meta: {},
              },
            ],
